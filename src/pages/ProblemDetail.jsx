...
const ProblemDetail = () => {
    ...
    const handleAISend = async (e) => {
        ...
        try {
            ...
            setAiMessages([...newMessages, { role: 'model', content: `Sorry, I encountered an error: ${error.message}` }]);
        } finally {
            setAiLoading(false);
        }
    };
                            ...
                            <>
                                <div className="flex items-center h-full">
                                    <button
                                        ...
                                        className={`px-4 py-2 text-xs font-bold transition-all relative ${activeTab === 'description' ? 'text-blue-400 border-b-2 border-blue-500' : 'text-gray-500 hover:text-gray-300'}`}
                                    >
                                        DESCRIPTION
                                    </button>
                                    <button
